    ...
    return (
        ...
        <Grid xs={12} sm={10} md={8} lg={6}>
            <div className='make-admin'>
                ...
                <div className='note'>
                    <span style={{fontWeight: 'bold'}}>Note: </span>Only An Admin can make another user role to Admin. Admin have some speacial freature like he can see and access some hidden page of this website. Also he can make another user role to admin. If you are not an Admin - Please skip this page. 
                </div>
            </div>
        </Grid>
